  ...
  var methods = {
    init: function (options) {
      var defaults = {
        ...
        defaultColor: "#000", // Fallback color for color thief.
        primaryColor: "#000", // Primary color that overrides color thief.
        secondaryColor: "#000", // Secondary color that overrides color thief.
      ...
      return this.each(function (i) {
        ...
        if (!placeholder.length) {
          origin.wrapInner($('<div class="placeholder hoverable"></div>'));
          placeholder = origin.children(".placeholder").first();
        }
        if (!$header.length) {
        ...
        origin
          ...
          .on("click.galleryExpand", function (e) {
            ...
            // add active class and hide Button New Recipe
            var btn_new = $("#btn-new-recipe");
